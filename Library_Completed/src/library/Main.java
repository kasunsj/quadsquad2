...
public class Main implements IMainListener {
	...
	public void borrowBooks() {
		...
		final BorrowUC_CTL ctl = new BorrowUC_CTL(reader, scanner, printer, display, bookDAO, loanDAO, memberDAO);
	...
	public static void main(String[] args) {
       ...
       memberDAO.addMember("fName0", "lName0", "0001", "email0");
      memberDAO.addMember("fName1", "lName1", "0002", "email1");  
