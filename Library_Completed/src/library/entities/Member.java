...
public class Member implements IMember{
  ...
  //method to return member hsoverdue or not
...
//member toretuen member hasFinesPayable or not
...
//method toadd fine in previouys fine
    ...
    //method to decrement in the fine by payingfine
...
//method to add the new loan in the previous loan
    ...
    // methood to return the list of loan
...
//method to remove the loan from list list of loan
   ...
   public String toString(){
       return ("first name :"+firstName+", Last name :"+lastName+", Contactno :"+contactPhone+", Email :"+emailAddress);
   } 
}
